...
| --- | --- | --- | --- | --- |
| 1 | Happy path reaches `done` with PR + review evidence | any | pass | issue `HARAA-3` lifecycle evidence and review comment in company `d48d56c4-46d6-4da6-adfa-ae8e282fdf65` |
...
| 4 | Non-queue repo allows direct `in_review -> done` after merge | disabled | pass | PR `#4` direct merge (`57331d8580d033a854a49916bd3be9663ceff3d9`) + `HARAA-3` done transition |
