...
| 2 | Block/unblock path preserves evidence and lifecycle integrity | any | not-run | pending dedicated execution run |
...
| 5 | Parity role set provisions full role catalog with instruction paths | any | not-run | pending setup script execution |
| 6 | Learning event captured immediately and reflected in retro | any | not-run | pending active issue run |
