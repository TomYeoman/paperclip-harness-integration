...
- [ ] **Scriptable change:** If Paperclip API behavior changed, setup/runbook steps are scriptable in `harness/scripts/`.
- [ ] **README updated:** `harness/scripts/README.md` updated to reflect new flags, defaults, order, or prerequisites.
